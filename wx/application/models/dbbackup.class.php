 ...
 */
 class dbbackup {
 	private $back_dir='./dbbackup/';//备份的路径
 	private $back_file=array();//当前已存在的备份
 	private $host='lcoalhost';
 	private $user='root';
 	private $pwd='123456';
 	private $conn;
 	private $dbname='sqxcard';
 	...
 	public function conn(){
		...
		$this->host = $dbConfig["DB_BASE"]["resources.db.params.host"];
		$this->user = $dbConfig["DB_BASE"]["resources.db.params.username"];
		$this->pwd  = $dbConfig["DB_BASE"]["resources.db.params.password"];
		$this->dbname = $dbConfig["DB_BASE"]["resources.db.params.dbname"];
