...
class interface_single_user // !--- MODIFY --- //
{
	public function getMenuDefine()
	{
		...
		$menuinfo = array(
			...
			'menutoggle' => array( //按钮间相互enable、diable关系，自己追加othermenu中的按钮动作
				...
				'gridclick' => array('btnModify','btnDelete','btnDetail','btnItemSort'),			//点击列表行时
	...
	public function getGridDefine()
	{
		$gridinfo = array(
			...
			'listfield' => array( //显示字段
				...
				array(
					'fieldname' => 'fullname',			//需要和sql语句中的字段名完全一致
					'dispname' => '用户名称',			//中文字段信息
				),
				array(
