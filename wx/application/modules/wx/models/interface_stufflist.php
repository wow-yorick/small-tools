...
class interface_single_stufflist // !--- MODIFY --- //
{
			...
			'searchmenu' => array( //搜索操作按钮定义
				...
				'items' => array(
					...
					'type' => array(
						...
						'class' => 'wiliz-slt',
						'colspan' => '1',
						'datasource' => $this->dbAll->all_getGlobalTypeGroup(),
						'valField' => 'groupName',
						'txtField' => 'groupName',
						'attr' => array(),
					),
	...
	public function getGridDefine()
	{
		$gridinfo = array(
			...
			'listfield' => array( //显示字段
				...
				array(
					'fieldname' => 'url',			//需要和sql语句中的字段名完全一致
					'dispname' => '素材地址',			//中文字段信息
				),
				array(
