...
if (!$smarty->is_cached('pinpai.dwt', $cache_id))
{
    assign_template();
	...
	$smarty->assign('categories1',     get_child_tree('179'));  //调用指定ID为大分类下的小类	
    ...
    $smarty->assign('cat_id180_best_goods', index_get_cat_id_goods_best_list(180,10));    // 指定商品调用
	...
	$smarty->assign('class_articles_4', index_get_class_articles(12,7)); // 分类调用文章 
...
$smarty->display('pinpai.dwt', $cache_id);
