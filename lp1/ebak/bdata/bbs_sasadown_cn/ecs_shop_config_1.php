...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','本源码由莎莎源码论坛bbs.sasadown.cn亲测提供','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','本源码由莎莎源码论坛bbs.sasadown.cn亲测提供','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','本源码由莎莎源码论坛bbs.sasadown.cn亲测提供','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','本源码由莎莎源码论坛bbs.sasadown.cn亲测提供','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','本源码由莎莎源码论坛bbs.sasadown.cn亲测提供','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','12345','1');");
