...
<div class="wrapper">
	<img src="http://www.dbyjrw.com/test/zbsq/mhsh/toutu1.php?name=<?=$_GET['name']?>" width="100%"/>
</div>
	...
	<div class="ui-form">
    	<form action="">
			...
			<div class="ui-form-item ui-border-b">
            	...
            	<div class="ui-select">
                	<select name="id">
                    	<option value ="1">王俊凯</option>
                    	<option value ="2">鹿晗</option>
						<option value ="3">权志龙</option>
                	</select>
            	</div>
        	</div>
