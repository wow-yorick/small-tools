...
if(!empty($_GET['key']))
{
	...
	if($_GET['type'] == 0)
	{
		...
		$n = ceil($imgW / 2) - strlen($_GET['text2']) * 5;
		imagefttext($img, 13, 0, $n, 190, $black, $font, $_GET['text2']);
		imagefttext($img, 13, 0, 20, 540, $black, $font, $_GET['text3']);
	}
	else
	{
		imagefttext($img, 13, 0, 20, 20, $black, $font, $_GET['text1']);
		$n = ceil($imgW / 2) - strlen($_GET['text2']) * 5;
		imagefttext($img, 13, 0, $n, 250, $black, $font, $_GET['text2']);
		imagefttext($img, 13, 0, 20, 560, $black, $font, $_GET['text3']);	
	}
...
<title>爱情的小船说翻就翻_友谊的小船说翻就翻</title>
</head>
<style>
...
<header style="padding:1rem 1rem 1rem 1rem;">
	<img src="./1.jpg" width="100%" style=""/>
</header>
<div style="height:1rem;"></div>
<div class="quan">
	<div class="ceng">
        <div class="right" style="width:95%;" id="go">
        	<span style="color:blue">翻船过于悲伤，这里有不翻船版>></span>
        </div>
    ...
    <div class="ceng" style="border-top:none;">
        ...
        <div class="right">
        	<select name="type" id="type" style="font-size:1rem; width:90%; border:none; background:none;">
            	<option value="0">爱情版</option>
                <option value="1">友情版</option>
            </select>
        </div>
        <div style="clear:both"></div>
    </div>
    <div class="ceng" style="border-top:none;">
        <div class="left">第一句</div>
        <div class="right">
        	<input type="text" id="text1" name="text1" placeholder="第一张图配话" style="background:none; border:none;font-size:1rem;"/>
        </div>
        <div style="clear:both"></div>
    </div>
    <div class="ceng" style="border-top:none;">
        <div class="left">第二句</div>
        <div class="right">
        	<input type="text" id="text2" name="text2" placeholder="第二张图配话" style="background:none; border:none;font-size:1rem;"/>
        </div>
        <div style="clear:both"></div>
    </div>
    <div class="ceng" style="border-top:none;">
        <div class="left">翻了</div>
        <div class="right">
        	<span> 爱情的小船说翻就翻</span>
        </div>
        <div style="clear:both"></div>
    ...
    <div class="ceng" style="border-top:none;">
        ...
        <div class="right">
        	<input type="text" id="text3" name="text3" placeholder="你的大名，落款处！" style="background:none; border:none;font-size:1rem;"/>
        </div>
        <div style="clear:both"></div>
    </div>
...
<?Php }else{?>
    ...
    <div style="height:0.7rem;"></div>
    <div class="queding" id="scq">小船说翻就翻生成器</div>
    <div style="height:0.7rem;"></div>
<?php }?>
...
<script>
	...
	$("#queding").click(function(){
		...
		window.location.href = "./yfc.php?key=1&type="+type+"&text1="+text1+"&text2="+text2+"&text3="+text3;
	});
