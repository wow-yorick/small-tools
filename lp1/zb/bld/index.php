...
<div class="wrapper">
	<img src="toutu.php?name=<?=$_GET['name']?>&time=<?=$_GET['time']?>" width="100%"/>
</div>
...
<div class="wrapper">
	...
	<div class="ui-form">
		...
		<form action="">
			...
			<div class="ui-form-item ui-border-b">
				<label for="#">登机时间</label>
				<input type="text" name="time" placeholder="格式：2016/05/01"/>
			</div>
