...
.follow img{width:180px;margin-top:10px;}
	...
	<div style="padding:20px 15px; height:110px;"><a class="ui-btn-lg ui-btn-danger" href="https://shop111329424.taobao.com" target="_blank">此处为广告位，更多源码>></a></div>
</div>
<footer class="ui-footer ui-footer-btn">
	<ul class="ui-tiled ui-border-t">
		<li class="ui-border-r"><a href="../"><div>更多装逼功能</div></a></li>
		<li class="ui-border-r"><a onClick="show()"><div>关注恋雪科技</div></a></li>
	</ul>
</footer>
<div id="follow" class="follow">
	...
	<!--<img src="http://open.weixin.qq.com/qr/code/?username=gh_c10b4cad200a">-->
</div>
