...
<ul class="ui-list ui-list-link ui-border-tb">
    ...
    <li class="ui-border-t" onClick="javascript:window.location.href='cj/'">
        ...
        <div class="ui-list-info">
            <h4 class="ui-nowrap">高考成绩单生成器</h4>
            <p class="ui-nowrap">兄弟！苦读三年，就这成绩了</p>
        </div>
    </li>

<li class="ui-border-t" onClick="javascript:window.location.href='fqjryzs/'">
        <div class="ui-list-img">
            <span class="ui-tag-new" style="background-image:url(fqjryzs/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
            <h4 class="ui-nowrap">荣誉父亲证书生成器</h4>
            <p class="ui-nowrap">父爱如山，吃苦耐劳</p>
        </div>
    </li>

<li class="ui-border-t" onClick="javascript:window.location.href='hfqzs/'">
        <div class="ui-list-img">
            <span class="ui-tag-new" style="background-image:url(hfqzs/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
            <h4 class="ui-nowrap">好爸爸荣誉证书生成器</h4>
            <p class="ui-nowrap">打你、骂你只想你成材</p>
        </div>
    </li>
...
<li class="ui-border-t" onClick="javascript:window.location.href='byqt/'">
        ...
        <div class="ui-list-info">
            <h4 class="ui-nowrap">包夜费欠条生成器</h4>
            <p class="ui-nowrap">去通知你兄弟，欠下的包夜费必须今天还了</p>
        </div>
    </li>

<li class="ui-border-t" onClick="javascript:window.location.href='xzs/'">
        <div class="ui-list-img">
            <span class="ui-tag-new" style="background-image:url(xzs/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
            <h4 class="ui-nowrap">地铁咸猪手生成器</h4>
            <p class="ui-nowrap">咸猪手？做哥们的都看不下去了</p>
        </div>
    </li>

<li class="ui-border-t" onClick="javascript:window.location.href='dttp/'">
        <div class="ui-list-img">
            <span class="ui-tag-new" style="background-image:url(dttp/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
            <h4 class="ui-nowrap">地铁偷拍生成器</h4>
            <p class="ui-nowrap">偷拍不给哥们看真是太过分了</p>
        </div>
    </li>

<li class="ui-border-t" onClick="javascript:window.location.href='xsshf/'">
        <div class="ui-list-img">
            <span class="ui-tag-new" style="background-image:url(xsshf/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
            <h4 class="ui-nowrap">小三生活费生成器</h4>
            <p class="ui-nowrap">兄弟竟然养着这么漂亮的小三</p>
        </div>
    </li>

<li class="ui-border-t" onClick="javascript:window.location.href='zjl/'">
        <div class="ui-list-img">
            <span  style="background-image:url(zjl/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='shuangrenjhz/'">
        <div class="ui-list-img">
            <span  style="background-image:url(shuangrenjhz/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
            <h4 class="ui-nowrap">双人结婚证生成器</h4>
            <p class="ui-nowrap">跟真的一样一样的</p>
        </div>
    </li>

<li class="ui-border-t" onClick="javascript:window.location.href='boywuyifan/'">
        <div class="ui-list-img">
            <span  style="background-image:url(boywuyifan/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='jjtzs/'">
        <div class="ui-list-img">
            <span  style="background-image:url(jjtzs/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
            <h4 class="ui-nowrap">戒酒通知书生成器</h4>
            <p class="ui-nowrap">我真的戒酒了，以后喝别叫我了！</p>
        </div>
    </li>

<li class="ui-border-t" onClick="javascript:window.location.href='huoche/'">
        <div class="ui-list-img">
            <span  style="background-image:url(huoche/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='xxsqs/'">
        <div class="ui-list-img">
            <span  style="background-image:url(xxsqs/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='iphone7/'">
        <div class="ui-list-img">
            <span  style="background-image:url(iphone7/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='diannao/'">
        <div class="ui-list-img">
            <span  style="background-image:url(diannao/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='beida/'">
        <div class="ui-list-img">
            <span  style="background-image:url(beida/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='gaokao/'">
        <div class="ui-list-img">
            <span  style="background-image:url(gaokao/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='ty/'">
        <div class="ui-list-img">
            <span  style="background-image:url(ty/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='peixun/'">
        <div class="ui-list-img">
            <span  style="background-image:url(peixun/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='dddh/'">
        <div class="ui-list-img">
            <span  style="background-image:url(dddh/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='bingli/'">
        <div class="ui-list-img">
            <span  style="background-image:url(bingli/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='hrbf/'">
        <div class="ui-list-img">
            <span  style="background-image:url(hrbf/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='pn/'">
        <div class="ui-list-img">
            <span style="background-image:url(pn/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='2016top/'">
        <div class="ui-list-img">
            <span style="background-image:url(2016top/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='bdjp/'">
        <div class="ui-list-img">
            <span style="background-image:url(bdjp/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
...
<li class="ui-border-t" onClick="javascript:window.location.href='mxsh/'">
        <div class="ui-list-img">
            <span style="background-image:url(mxsh/icon.jpg)"></span>
        </div>
        <div class="ui-list-info">
