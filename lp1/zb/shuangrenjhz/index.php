	...
	<div class="ui-form">
    	<form action="">
        	...
        	<div class="ui-form-item ui-border-b">
            	<label>持证人</label>
            	<input type="text" name="name" placeholder="输入男方的姓名">
        	</div>
			<div class="ui-form-item ui-border-b">
            	<label>持证人</label>
            	<input type="text" name="namea" placeholder="输入女方的姓名">
        	</div>
			<div class="ui-form-item ui-border-b">
            	<label>寄语</label>
            	<input type="text" name="nameb" placeholder="底部7-10个字">
        	</div>
