	...
	<div class="ui-form">
    	<form action="">
			...
			<div class="ui-form-item ui-border-b">
            	...
            	<div class="ui-select">
                	<select name="id">
					<option value ="咱们永远是兄弟">咱们永远是兄弟</option>
                    	<option value ="我要跟你单挑!">我要跟你单挑</option>
                    	<option value ="不服气你就来!">不服气你就来</option>
						<option value ="敢不敢来一场!">敢不敢来一场</option>
						<option value ="谁输谁是小弟!">谁输谁是小弟</option>
                	</select>
            	</div>
        	</div>
