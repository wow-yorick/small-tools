...
<div class="wrapper">
		...
		<img src="toutu.php?name=<?=$_GET['name']?>&date=<?=$_GET['date']?>" width="100%"/>
	...
	<div class="ui-form">
    	<form action="">
        	...
        	<div class="ui-form-item ui-border-b">
            	<label>买家</label>
            	<input type="text" name="name" placeholder="输入买家的姓名">
        	</div>
		<div class="ui-form-item ui-border-b">
            	<label>日期</label>
            	<input type="text" name="date" placeholder="例如2016-06-11">
        	</div>
