...
if ($action == 'act_add_message')
{
    ...
    $message = array(
		...
		'msg_contact' => isset($_POST['contact']) ? trim($_POST['ontact']) : '', 
		'msg_phone'   => isset($_POST['phone']) ? trim($_POST['phone']) : '', 
		'msg_company' => isset($_POST['company']) ? trim($_POST['company']) : '', 
        'msg_type'    => isset($_POST['msg_type']) ? intval($_POST['msg_type'])     :  '',
